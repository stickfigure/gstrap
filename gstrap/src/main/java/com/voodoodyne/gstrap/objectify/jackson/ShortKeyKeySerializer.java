...
/**
 * Configuring this serializer will make Key<?> objects render as their short string *when they are used as Map keys*.
 */
@SuppressWarnings("rawtypes")
@RequiredArgsConstructor
public class ShortKeyKeySerializer extends JsonSerializer<Key> {
